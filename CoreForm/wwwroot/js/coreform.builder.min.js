            ...
            <div class="uk-modal-footer uk-text-right">
				...
				<component v-for="field in column.fields" 
				 ...
				 :schema="field"></component>
                   ...
                   </div>`,validations:{label:{required:required,minLength:minLength(3)}},data:function(){return this.value},props:["value"]}};passwordInput=extend(textInput,{type:"passwordField"});Object.assign(passwordInput.fieldTemplate.computed,{inputType:function(){return"password"}});RegisterField(textInput);RegisterField(passwordInput);RegisterField({type:"richtextField",display:"Richtext Field",buildNewModel:function(){return{label:"New label",variable:"",placeholder:"",source:"",multiple:!1}},fieldTemplate:{template:`<cf_field :schema="schema"><label :for="schema.id" class="uk-form-label">{{ schema.label }} <div class="required-tag" v-if="$isrequired"/></label>
    ...
    <span class="ql-formats">
      ...
      <button class="ql-image"></button>
                ...
                <div class="error-message">{{this.$errorMessage}}</div>
                   ...
                   </div>`,validations:{label:{required:required,minLength:minLength(3)}},data:function(){return this.value},props:["value"]}});RegisterField({type:"selectField",display:"Dropdown select",buildNewModel:function(){return{label:"New label",variable:"",placeholder:"",source:"",multiple:!1}},fieldTemplate:{template:`<cf_field :schema="schema"><label :for="schema.id" class="uk-form-label">{{ schema.label }} <div class="required-tag" v-if="$isrequired"/></label>
                <div class="uk-form-control bt-select-field" v-bind:class="{'uk-form-danger': this.$error}">
